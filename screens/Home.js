...
export default class HomeScreen extends Component {
  ...
  getMovie = () => {
    const url = "http://be0b-42-110-180-149.ngrok.io/get-movie";
    axios
      .get(url)
      .then(response => {
  ...
  likedMovie = () => {
    const url = "http://be0b-42-110-180-149.ngrok.io/liked-movie";
    axios
      .post(url)
      .then(response => {
        this.getMovie();
  ...
  unlikedMovie = () => {
    const url = "http://be0b-42-110-180-149.ngrok.io/not-liked-movie";
    axios
      .post(url)
      .then(response => {
        this.getMovie();
  ...
  notWatched = () => {
    const url = "http://be0b-42-110-180-149.ngrok.io/not-seen";
    axios
      .post(url)
      .then(response => {
        this.getMovie();
